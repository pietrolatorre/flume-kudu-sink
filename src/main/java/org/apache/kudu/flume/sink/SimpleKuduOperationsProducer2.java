 ...
 * </table>
 */
public class SimpleKuduOperationsProducer2 implements KuduOperationsProducer {
  ...
  public SimpleKuduOperationsProducer2(){
  }
  ...
  public List<Operation> getOperations(Event event) throws FlumeException {
    try {
      ...
      String key =""+Math.random()*1000;
      row.addString("r", key);
      row.addString("b", event.getBody().toString());
